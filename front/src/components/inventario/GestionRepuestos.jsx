    ...
    return (
        <Container maxWidth="xl" sx={{ mt: 9, mb: 4 }}>
            ...
            <Dialog open={openModal} onClose={() => setOpenModal(false)} fullWidth maxWidth="sm">
                <DialogTitle>{editMode ? 'Editar Repuesto' : 'Añadir Nuevo Repuesto'}</DialogTitle>
                <DialogContent sx={{ pt: 2 }}>
                    <Stack spacing={2} sx={{ mt: 1 }}>
                        ...
                        <TextField label="Marca" fullWidth size="small" value={currentRepuesto.marca} onChange={(e) => setCurrentRepuesto({...currentRepuesto, marca: e.target.value})} />
                        <TextField label="Modelo" fullWidth size="small" value={currentRepuesto.modelo} onChange={(e) => setCurrentRepuesto({...currentRepuesto, modelo: e.target.value})} />
                        <TextField label="Descripción" fullWidth size="small" multiline rows={2} value={currentRepuesto.descripcion} onChange={(e) => setCurrentRepuesto({...currentRepuesto, descripcion: e.target.value})} />
                        <Stack direction="row" spacing={2}>
                            <TextField label="Stock Inicial" type="number" fullWidth size="small" value={currentRepuesto.stock_actual} onChange={(e) => setCurrentRepuesto({...currentRepuesto, stock_actual: e.target.value})} />
                            <TextField label="Stock Mínimo" type="number" fullWidth size="small" value={currentRepuesto.stock_minimo} onChange={(e) => setCurrentRepuesto({...currentRepuesto, stock_minimo: e.target.value})} />
                        </Stack>
                    </Stack>
                </DialogContent>
                <DialogActions>
